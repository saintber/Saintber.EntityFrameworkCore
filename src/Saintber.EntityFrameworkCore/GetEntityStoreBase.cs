namespace Saintber.EntityFrameworkCore
{
    ...
    public abstract class GetEntityStoreBase<TEntity, TModel, TFilterModel>
        : IGetEntityStore<TEntity, TModel, TFilterModel>
    {
        private readonly IEntityStore<TEntity> entityStore;

        public GetEntityStoreBase(IEntityStore<TEntity> entityStore)
        {
